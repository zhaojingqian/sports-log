...
.chart{height:382px}.chart.short{height:252px}.chart-tip{border-radius:8px;background:rgba(11,20,38,.96);box-shadow:0 18px 48px rgba(15,27,51,.24)}
...
@media(max-width:640px){.main{padding:14px}.title h1{font-size:26px}.card,.panel{padding:14px}.chart{height:304px}.chart.short{height:228px}}

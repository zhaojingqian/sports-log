...
<style>
:root{color-scheme:light;--ink:#111816;--muted:#66746d;--faint:#8a958f;--paper:#f6f3eb;--panel:#fffdfa;--panel2:#f8f5ee;--line:#dfdbd1;--line2:#ebe6dc;--green:#168765;--teal:#168ca1;--coral:#d86549;--gold:#c98f25;--shadow:0 18px 52px rgba(26,36,31,.10);--font:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:radial-gradient(circle at 18% -10%,#eff8ef 0,#f6f3eb 36%,#eee9dc 100%);color:var(--ink);font-family:var(--font);letter-spacing:0;font-size:14px;line-height:1.45;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
button{font:inherit}.shell{max-width:1220px;margin:0 auto;padding:18px}.top{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px}.brand{display:flex;align-items:center;gap:10px}.mark{width:34px;height:34px;border-radius:50%;background:conic-gradient(from 210deg,var(--green),var(--teal),var(--gold),var(--coral),var(--green));box-shadow:inset 0 0 0 7px #fff9}.brand h1{font-size:18px;line-height:1.1;margin:0;font-weight:740;letter-spacing:-.01em}.brand span{font-size:11px;color:var(--faint)}.seg{display:flex;background:rgba(255,253,250,.78);border:1px solid var(--line);border-radius:8px;padding:3px;gap:2px;box-shadow:0 8px 28px rgba(20,28,24,.06)}.seg button{border:0;background:transparent;border-radius:6px;padding:6px 9px;color:var(--muted);cursor:pointer;font-size:12px;font-weight:640;min-width:42px}.seg button.active{background:var(--ink);color:white}
.hero{display:grid;grid-template-columns:minmax(0,1.34fr) minmax(316px,.66fr);gap:12px;margin-bottom:12px}.stage{position:relative;min-height:322px;border:1px solid var(--line);border-radius:8px;background:linear-gradient(135deg,#fffdf6 0,#e8f4ef 52%,#f8e8da 100%);overflow:hidden;padding:20px;box-shadow:var(--shadow)}.stage canvas{position:absolute;inset:0;width:100%;height:100%}.hero-copy{position:relative;z-index:1;display:flex;flex-direction:column;height:100%;justify-content:space-between}.kicker{display:flex;gap:7px;flex-wrap:wrap}.chip{display:inline-flex;align-items:center;border:1px solid rgba(255,255,255,.72);background:rgba(255,255,255,.64);backdrop-filter:blur(8px);border-radius:999px;padding:6px 9px;font-size:11px;font-weight:620;color:#43524c}.headline{margin-top:64px}.headline strong{display:block;font-size:clamp(44px,7vw,72px);font-weight:780;letter-spacing:-.045em;line-height:.9}.headline span{display:block;color:var(--muted);margin-top:10px;font-size:13px;font-weight:540}.side{display:grid;gap:12px}.ring-card,.panel,.metric{border:1px solid var(--line);border-radius:8px;background:rgba(255,253,250,.88);box-shadow:var(--shadow)}.ring-card{padding:18px;display:grid;grid-template-columns:136px 1fr;gap:14px;align-items:center}.ring{position:relative;width:132px;height:132px}.ring svg{width:132px;height:132px;transform:rotate(-90deg)}.ring circle{fill:none;stroke-width:12;stroke-linecap:round}.ring .bg{stroke:#e7e1d5}.ring .fg{stroke:var(--green);stroke-dasharray:0 999}.ring b{position:absolute;inset:0;display:grid;place-items:center;font-size:30px;font-weight:760;letter-spacing:-.03em}.ring-card h2{margin:0 0 6px;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:var(--faint);font-weight:720}.ring-card .big{font-size:26px;line-height:1.08;font-weight:760;letter-spacing:-.025em}
.metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:12px}.metric{padding:14px;min-height:104px}.metric span,.panel h2 small{display:block;color:var(--faint);font-size:11px;font-weight:620}.metric b{display:block;font-size:26px;line-height:1.05;font-weight:760;letter-spacing:-.035em;margin:8px 0 9px}.spark{width:100%;height:28px}.grid{display:grid;grid-template-columns:1.22fr .78fr;gap:12px}.panel{padding:16px;min-width:0}.panel h2{display:flex;align-items:flex-end;justify-content:space-between;margin:0 0 12px;font-size:14px;font-weight:740;letter-spacing:-.01em}.canvas-wrap{height:286px;position:relative}.canvas-wrap canvas{width:100%;height:100%}.trio{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.tile{border:1px solid var(--line2);border-radius:8px;background:var(--panel2);padding:11px;min-width:0}.tile b{display:block;font-size:18px;line-height:1.1;font-weight:740;letter-spacing:-.02em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.tile span,.summary span,.pred span{display:block;color:var(--faint);font-size:11px;font-weight:620}.heat{display:grid;grid-template-columns:repeat(19,1fr);gap:4px}.cell{aspect-ratio:1;border-radius:4px;background:#e7e2d7;position:relative}.cell[data-lvl="1"]{background:#bddcc9}.cell[data-lvl="2"]{background:#74bd91}.cell[data-lvl="3"]{background:#28976d}.cell[data-lvl="4"]{background:#12644a}.activity-list{display:grid;gap:8px;max-height:458px;overflow:auto;padding-right:2px}.activity{display:grid;grid-template-columns:50px 1fr auto;gap:10px;align-items:center;border:1px solid var(--line2);background:#fffaf2;border-radius:8px;padding:9px;cursor:pointer;transition:transform .16s ease,border-color .16s ease,background .16s ease}.activity:hover{border-color:#bdc9c0;background:#fffdf8;transform:translateY(-1px)}.badge{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:#e8f3ee;color:#126046;font-size:14px;font-weight:760}.activity h3{margin:0;font-size:13px;line-height:1.25;font-weight:710;letter-spacing:-.01em}.activity p{margin:3px 0 0;color:var(--faint);font-size:11px}.activity .num{text-align:right;font-size:12px;font-weight:760}.filters{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px}.filters button{border:1px solid var(--line);background:#fffaf2;border-radius:999px;padding:5px 9px;color:var(--muted);cursor:pointer;font-size:11px;font-weight:650}.filters button.active{background:var(--ink);color:white;border-color:var(--ink)}
.wide{grid-column:1/-1}.summary-row{display:grid;grid-template-columns:repeat(5,1fr);gap:8px}.summary{border:1px solid var(--line2);border-radius:8px;background:#fffaf2;padding:12px;min-height:104px}.summary b{display:block;font-size:21px;line-height:1.1;font-weight:760;letter-spacing:-.025em;margin:5px 0}.progress{height:7px;background:#e8e2d6;border-radius:999px;overflow:hidden;margin-top:10px}.progress i{display:block;height:100%;background:linear-gradient(90deg,var(--green),var(--gold));width:0}.preds{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.pred{border:1px solid var(--line2);border-radius:8px;padding:11px;background:var(--panel2)}.pred b{display:block;font-size:19px;font-weight:760;letter-spacing:-.02em}.muted{color:var(--muted);font-size:12px}.detail-drawer{position:fixed;right:18px;bottom:18px;width:min(420px,calc(100% - 36px));background:#151d1a;color:white;border-radius:8px;padding:18px;box-shadow:0 24px 80px #0007;transform:translateY(130%);transition:.25s ease;z-index:5}.detail-drawer.show{transform:translateY(0)}.detail-drawer button{position:absolute;right:12px;top:10px;border:0;background:#ffffff18;color:white;border-radius:50%;width:30px;height:30px;cursor:pointer}.detail-drawer h2{margin:0 36px 12px 0;font-size:18px;letter-spacing:-.02em}.detail-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.detail-stats div{background:#ffffff12;border-radius:8px;padding:10px}.detail-stats span{display:block;color:#b9c6c0;font-size:11px}.detail-stats b{font-size:15px}.empty{color:var(--muted);padding:18px;font-size:12px}
...
@media (max-width:560px){.shell{padding:12px}.top{align-items:flex-start;gap:10px}.seg{overflow:auto;max-width:100%}.seg button{min-width:38px;padding:6px 8px}.hero{gap:10px}.stage{min-height:286px}.headline{margin-top:42px}.ring-card{grid-template-columns:1fr}.metrics,.summary-row,.preds{grid-template-columns:1fr}.activity{grid-template-columns:44px 1fr}.activity .num{grid-column:2;text-align:left}.heat{grid-template-columns:repeat(10,1fr)}}
</style>
</head>
<body>
<main class="shell">
